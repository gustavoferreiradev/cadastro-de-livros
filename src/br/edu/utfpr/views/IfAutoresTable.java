...
public class IfAutoresTable extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnPesquisar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/32x32/Search-icon (Custom).png"))); // NOI18N
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        DlgListaLivros pesquisa = new DlgListaLivros(null, true);
