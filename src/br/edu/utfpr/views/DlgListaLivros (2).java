 ...
 * @author gustavo
 */
public class DlgListaLivros extends javax.swing.JDialog {
    ...
    public DlgListaLivros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LivrosDAO livrosDao = new LivrosDAO();
        listaLivros = livrosDao.getLivros();
        livrosTableModel = new LivrosTableModel(listaLivros);
        tabelaResultados.setModel(livrosTableModel);
    }
    ...
    private void tfPesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfPesquisaKeyReleased
        this.tableRowSorter = new TableRowSorter(livrosTableModel);
...
//            java.util.logging.Logger.getLogger(DlgListaLivros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                DlgListaLivros dialog = new DlgListaLivros(new javax.swing.JFrame(), true);
